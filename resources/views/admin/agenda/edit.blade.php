...
<div class="container-fluid py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h4 class="fw-bold text-primary m-0">Edit Agenda Sekolah</h4>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-12">
                        ...
                        <input type="text" name="judul" class="form-control @error('judul') is-invalid @enderror" 
                               value="{{ old('judul', $agenda->judul) }}" placeholder="Contoh: Rapat Wali Murid" required>
                        @error('judul')
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="date" name="tgl_agenda" class="form-control @error('tgl_agenda') is-invalid @enderror" 
                               value="{{ old('tgl_agenda', $agenda->tanggal_mulai) }}" required>
                        @error('tgl_agenda')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="date" name="tgl_akhir" class="form-control @error('tgl_akhir') is-invalid @enderror" 
                               value="{{ old('tgl_akhir', $agenda->tanggal_selesai) }}" required>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="color" name="warna" class="form-control form-control-color w-100" 
                               value="{{ old('warna', $agenda->warna ?? '#0d6efd') }}" title="Pilih warna untuk kalender">
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="tipe" class="form-select">
                            <option value="event" {{ $agenda->tipe == 'event' ? 'selected' : '' }}>Event Umum</option>
                            <option value="libur" {{ $agenda->tipe == 'libur' ? 'selected' : '' }}>Hari Libur</option>
                            <option value="ujian" {{ $agenda->tipe == 'ujian' ? 'selected' : '' }}>Ujian / Akademik</option>
                            <option value="kegiatan" {{ $agenda->tipe == 'kegiatan' ? 'selected' : '' }}>Kegiatan Sekolah</option>
                        </select>
                    </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <input type="text" name="lokasi" class="form-control" 
                               value="{{ old('lokasi', $agenda->lokasi) }}" placeholder="Contoh: Aula Sekolah">
                    </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <textarea name="isi" rows="6" class="form-control @error('isi') is-invalid @enderror" 
                                  placeholder="Tulis detail agenda di sini..." required>{{ old('isi', $agenda->isi) }}</textarea>
                        @error('isi')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
